...
export default function Message({ onSendMessage }: IMessageProps) {
  ...
  return (
    <div className="flex bg-SemiWhite fixed bottom-60  left-0 px-13 py-8 w-full items-center gap-10">
      <input
        type="text"
        value={message}
        ...
        className="w-full rounded-xl px-8 py-10 font-normal text-SemiBlack text-14 placeholder:text-Gray outline-none focus:border-MainColor"
      />
